...
for base in [ROOT.parent/'source_certificate/.build/Compiler',COMP/'.lake/build/lib/lean/Compiler',ROOT.parent/'engine_refinement/.build/Compiler',ROOT.parent.parent/'integer_certificate_emission/build/Compiler',ROOT.parent.parent/'integer_certificate_emission/optimization/build/Compiler']:
...
for name in sys.argv[1:] or ['FheTargetProjection']:
