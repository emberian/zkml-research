#!/usr/bin/env python3
"""Designated DDH: independent public-history verification before ciphertext ACK.
This process has no recipient scalars and never decodes. Private drain is a
separate role; the 16-key recipient coalition still has the full fixed span.
"""
