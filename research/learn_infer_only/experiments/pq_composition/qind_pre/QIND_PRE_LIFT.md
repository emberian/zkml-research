[OPEN closeout] This derived conditional lift remains a review draft. Independent finite premise controls are saved in experiments/adversarial_review/qind_pre/results.json; the reviewer was interrupted before its final report. No source-backed primitive instantiation or accepted whole-resident PQ conclusion is claimed.
