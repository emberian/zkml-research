#!/usr/bin/env python3
"""Check only this five-module bridge in a supplied prepared minidregg isolate."""
from pathlib import Path
import argparse,hashlib,json,re,subprocess,time
MODULES=['Compiler/AirPolynomialOod.lean','Compiler/Ir2AirPcsOod.lean','Compiler/BfvQueryPolynomialOod.lean','Compiler/Ir2QuotientRecomposition.lean','Compiler/Ir2AirPcsOodWitnesses.lean']
