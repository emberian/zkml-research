...
def main():
 ...
 out={'execution_completed':True,'score_attempts':1,'actual_forward_examples':len(rows),'actual_model_forward_calls':len(batches),
  'new_test_texts':128,'framings':1,'semantic_bits_per_framing':256,'pairs_per_framing':128,
  'heldout_inputs':128,'utility_history_runs':0,'generated_tokens':0,'weight_updates':0,
