...
LIVE = HERE.parent / 'live_learner'
sys.path.insert(0, str(LIVE))
import live
from live import j

PIPELINE = BASE / 'query_runtime/run.py'
...
def source_pins():
    paths = [Path(__file__), LIVE / 'live.py', PIPELINE, PIPELINE.parent / 'PIPELINE.json', NATIVE, TEMPLATE]
