/* @ts-self-types="./ring_browser_verifier.d.ts" */
 ...
 * @returns {string}
 */
export function verify_bundle(statement, proof) {
    let deferred3_0;
    let deferred3_1;
    try {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ring_browser_verifier_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ring_browser_verifier_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
