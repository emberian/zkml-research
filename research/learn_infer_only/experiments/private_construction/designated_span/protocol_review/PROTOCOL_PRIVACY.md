...
coalition J before setup. The host may know every journal, issuer and command
authentication secret; these keys are sampled independently of the private
encryption master and input contents. It may know recipient scalars for J and
all their setup messages. It does not receive the initializer's master/copies,
fresh input randomizers, noncoalition recipient scalars or the private issuer's
input history. Honest private setup and erasure are explicit assumptions.
