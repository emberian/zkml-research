...
def main():
 ...
 for p in private_files:
  assert p.read_bytes() not in all_public and sha(p).encode() not in all_public
 ...
 result={'ok':True,'source_model_query_and_parent_pins_match':True,'parent_entries_preserved':parent_counts,
         'secret_files_scanned_raw_hex_base64':4,'private_text_prompt_vector_score_files_and_hashes_omitted':True,
