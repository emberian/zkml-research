//! Thin consumer of the existing DescriptorIR-v2 HidingFRI verifier.
...
use dregg_circuit::descriptor_proof_backend::{
    DescriptorProofVerifier, DescriptorStatement, Plonky3HidingFriReference,
};
...
pub fn verify_core(
    ...
    let mut outcome = Verification {
        verified: false,
        backend: Plonky3HidingFriReference::BACKEND_ID,
        public_rows: 0,
        public_width: 0,
