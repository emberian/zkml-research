...
open Minidregg.Compiler.AirSimplify Minidregg.Compiler.ProfiledWitness
...
def ir2Template (terms : ConstraintSystem BabyBear Nat) : String :=
  ...
  "{\"name\":\"nonlinear_exact_rescale_profiled_rows\",\"ir\":2,\"trace_width\":"++toString nVars++
...
def main (args : List String) : IO UInt32 := do
  ...
  let cache := caches profile rowLayout rows
