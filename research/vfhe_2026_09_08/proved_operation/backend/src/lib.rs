...
impl DescriptorProofVerifier for FixedPublicPreprocessing {
    ...
    const BACKEND_ID:&'static str="plonky3-hidingfri-babybear-ir2@82cfad73cd734d37a0d51953094f970c531817ec|lb3|lfp0|arity3|q38|qpow16|ext4|salt4|random-codewords4|public-preprocessing-xoshiro256pp-0.8.1-v1";
