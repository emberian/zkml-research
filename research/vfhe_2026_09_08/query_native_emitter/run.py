...
"""
import argparse, datetime, hashlib, json, os, pathlib, resource, subprocess, sys, time
...
def main():
    ...
    try:
        ...
        # Additive native witness path. The existing public reader, source
        # template, prover and fresh verifier are unchanged.
        step('emit',[sys.executable,cfg['witness_wrapper'],generated,case/'public_rows.json'],HERE,60)
