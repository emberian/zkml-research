...
def main():
 ...
 if a.mode=='prepare':prepare(reports)
  ...
  require(review['disposition']=='accepted' and review['root_notified'] is True and review['execution_pins_sha256']==file_sha(reports/'execution_pins.json') and review['source_pins_sha256']==file_sha(HERE/'SOURCE_PINS.json'),'exactIndependentReviewBeforeWorker')
  require(file_sha(review['review_report_path'])==review['review_report_sha256'],'workerReviewReportPin')
