...
FORMAL = ROOT / "formal/he_closure_costs/source_phase"
BUILD = FORMAL / "build"
...
for base in [ROOT / "formal/he_closure_costs/build", ROOT / "formal/durable_integration/bfv_window/build", Path("/Users/ember/dev/minidregg/.lake/build/lib/lean")]:
...
modules = sys.argv[1:] or ["Theory/BfvPhaseAlgebra", "Assurance/ResidentBfvSourcePhase"]
