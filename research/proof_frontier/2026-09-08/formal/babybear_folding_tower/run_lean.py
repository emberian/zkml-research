...
record={'command':cmd,'cwd':str(repo),'exit_code':r.returncode,'source_sha256':source_sha256,'source_unchanged':source_sha256==hashlib.sha256((repo/module).read_bytes()).hexdigest(),'elapsed_s':time.time()-started,'log':str(root/'logs'/f'{tag}.log')}
